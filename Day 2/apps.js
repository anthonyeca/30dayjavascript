...
//23.
console.log("Excercise 23 ")
let pattern = /a/gi
console.log(challenge.match(pattern))
//24.
let word2 = "30 Days of"
...
console.log(string1.endsWith('on'))
//6. 
...
let buscarInicial = phrase.search("because")
let buscarFinal = phrase.lastIndexOf("because")
console.log(phrase.substr(buscarInicial, (buscarFinal - buscarInicial + "because".length)))
...
let count = phrase1.match(pattern1)
console.log(`There is ${count.length} Love's in the text `)
//2. 
let phrase2 = 'You cannot end a sentence with because because because is a conjunction'
let pattern2 = /because/gi
let count1 = phrase2.match(pattern2)
console.log(`There is ${count1.length} because's in the text `)
//3.
...
console.log(sentence1.replace(/[^A-Z , a-z !? . \d]/g, ''))
//4.
let salary = 'He earns 5000 euro from salary per month, 10000 euro annual bonus, 15000 euro online courses per month'
let arr = salary.match(/\d+/g)
let monthly = arr[0] * 12
let annualBonus = parseInt(arr[1])
let onlineCourses = arr[2] * 12
let annualIncome = monthly + annualBonus + onlineCourses
